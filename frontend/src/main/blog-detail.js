                        ...
                        <div className="lg:col-span-4 md:col-span-6">
                            <div className="sticky top-20">
                                ...
                                <div className="text-center mt-8">
                                    ...
                                    <Link to="" className="text-lg font-medium hover:text-violet-600 transition-all duration-500 ease-in-out h5">Cristina Romsey</Link>
