...
export default function GetInTouch() {
    return (
        <>
            <section className="relative lg:py-28 md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="contact">
                            ...
                            <div className="lg:ms-8">
                                <div className="flex">
                                    ...
                                    <div className="flex-1 ms-6">
                                        ...
                                        <Link to="tel:+152534-468-854" className="text-slate-400">+152 534-468-854</Link>
                                    </div>
                                </div>
                                ...
                                <div className="flex mt-4">
                                    ...
                                    <div className="flex-1 ms-6">
                                        ...
                                        <Link to="mailto:contact@example.com" className="text-slate-400">contact@example.com</Link>
                                    </div>
                                </div>
